...
data class ConsoleUiState(
    ...
    // Quick commands available for sending to the terminal
...
class ConsoleViewModel @Inject constructor(
    ...
    init {
        // Observe quick commands so the picker is always up-to-date
        viewModelScope.launch {
            quickCommandRepository.observeAll().collect { commands ->
