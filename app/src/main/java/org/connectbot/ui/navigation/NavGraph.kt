...
import org.connectbot.ui.screens.filebrowser.FileBrowserScreen
    ...
    NavHost(
        ...
        composable(
            ...
            ConsoleScreen(
                ...
                onNavigateToFileBrowser = { bridgeName ->
                    navController.navigateSafely(
                        "${NavDestinations.FILE_BROWSER}/${android.net.Uri.encode(bridgeName)}",
                    )
                },
            )
        }
        ...
        composable(
            route = "${NavDestinations.FILE_BROWSER}/{${NavArgs.BRIDGE_NAME}}",
            arguments = listOf(
                navArgument(NavArgs.BRIDGE_NAME) { type = NavType.StringType },
            ),
        ) {
            FileBrowserScreen(
                onNavigateBack = { navController.safePopBackStack() },
