...
public final class DaggerConnectBotApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends ConnectBotApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.connectionNotifierProvider = DoubleCheck.provider(new SwitchingProvider<ConnectionNotifier>(singletonCImpl, 18));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new LanguagePackManagerImpl(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 18: // org.connectbot.service.ConnectionNotifier
